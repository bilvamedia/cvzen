...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join cvZen</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>You've been invited</Heading>
        <Text style={subtitle}>Intelligent Hiring OS</Text>
        <Text style={text}>
          You've been invited to join cvZen. Click the button below to accept the invitation and create your account.
        </Text>
