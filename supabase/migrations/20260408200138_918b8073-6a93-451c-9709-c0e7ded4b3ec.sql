...
-- 2. Create a security definer function that returns only safe public fields
...
AS $$
  SELECT p.id, p.full_name, p.headline, p.bio, p.avatar_url,
         p.linkedin_url, p.website_url, p.social_links, p.profile_slug
