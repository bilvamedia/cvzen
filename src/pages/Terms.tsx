        ...
        <div className="prose prose-sm max-w-none space-y-8 text-foreground/85">
          <section>
            ...
            <p className="text-sm mt-2">
              ...
              <strong>Information Technology Act, 2000</strong>, and applicable rules thereunder, while also respecting
              EU and US consumer protection standards.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-sm">
              ...
              <li>
                If using on behalf of an organization, you represent that you have authority to bind that organization.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              You retain ownership of all content you upload (resumes, profile information, etc.). By uploading content,
              you grant cvZen a limited, non-exclusive, royalty-free license to process, store, and display your content
              solely for providing the Services.
            </p>
            <h3 className="text-base font-semibold text-foreground mt-4 mb-2">5.2 Platform IP</h3>
            <p className="text-sm">
              The Platform, its design, features, AI models, algorithms, and all related intellectual property are owned
              by cvZen. You may not copy, modify, reverse-engineer, or create derivative works from any part of the
              Platform.
            </p>
            <h3 className="text-base font-semibold text-foreground mt-4 mb-2">5.3 AI-Generated Content</h3>
            <p className="text-sm">
              Improvement suggestions and AI-generated content provided by the Platform are tools to assist you. You are
              responsible for reviewing and using such content at your own discretion. cvZen does not guarantee the
              accuracy or suitability of AI-generated suggestions.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-sm">
              <li>
                Prices are displayed in the applicable currency (INR for Indian users, USD/EUR for international users).
              </li>
              <li>
                All prices for Indian users are inclusive of GST (18%) as per the Goods and Services Tax Act, 2017.
              </li>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-sm">
              <li>
                <strong>India:</strong> Payments processed via RBI-regulated payment gateways (UPI, Net Banking, Cards,
                Wallets). Compliant with RBI guidelines on digital payments.
              </li>
              <li>
                <strong>International:</strong> Payments processed via PCI-DSS Level 1 compliant processors.
              </li>
              <li>
            ...
            <p className="text-sm">
              Tax invoices will be issued in compliance with GST regulations for Indian users and applicable tax laws
              for international users. Invoices are available in your account dashboard.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-muted rounded-lg p-4 text-sm space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Full refund within <strong>7 days</strong> of purchase if no services have been consumed.
                </li>
                <li>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <strong>14-day cooling-off period</strong> for digital services (right of withdrawal).
                </li>
                <li>
                  If you consented to immediate performance and acknowledged loss of withdrawal right, partial refund
                  may apply.
                </li>
                <li>
                  Refunds processed and credited within <strong>14 days</strong> of withdrawal request.
                </li>
              </ul>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  Refunds processed and credited within <strong>5-10 business days</strong>.
                </li>
              </ul>

              <p className="mt-3 text-xs text-muted-foreground">
                To request a refund, email <strong>billing@cvzen.ai</strong> with your account details and reason for
                refund.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-sm mt-2">
              ...
              <li>
                We do not guarantee employment outcomes, interview selections, or hiring decisions based on the use of
                our Platform.
              </li>
              <li>AI-generated suggestions are advisory only and do not constitute professional career advice.</li>
            </ul>
            <p className="text-sm mt-2">
              <strong>For Indian users:</strong> This clause is subject to the Consumer Protection Act, 2019, and does
              not limit liability for gross negligence or willful misconduct.
            </p>
            <p className="text-sm mt-1">
              <strong>For EU users:</strong> Nothing in these Terms limits liability for death, personal injury caused
              by negligence, fraud, or fraudulent misrepresentation.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              These Terms are governed by the laws of India. For EU users, mandatory consumer protection laws of your
              country of residence also apply.
            </p>
            <h3 className="text-base font-semibold text-foreground mt-4 mb-2">10.2 Arbitration (India)</h3>
            <p className="text-sm">
              Disputes shall be resolved through arbitration under the Arbitration and Conciliation Act, 1996, seated in
              Bengaluru, India. The language of arbitration shall be English.
            </p>
            <h3 className="text-base font-semibold text-foreground mt-4 mb-2">10.3 Consumer Forums</h3>
            <p className="text-sm">
              Indian consumers retain the right to approach the appropriate Consumer Dispute Redressal Commission under
              the Consumer Protection Act, 2019. EU consumers may use the EU Online Dispute Resolution platform.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-sm">
              ...
              <li>
                We may suspend or terminate your account for violation of these Terms with prior notice (except in cases
          ...
          <section>
            ...
            <p className="text-sm">
              We may update these Terms with 30 days prior notice via email or platform notification. Continued use
              after the effective date constitutes acceptance. Material changes require explicit consent for Indian and
              EU users.
            </p>
          </section>
